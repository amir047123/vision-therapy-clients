...
const ModalTheShooter = ({ isOpen, onRequestClose }) => {
  return (
    <ReactModal
      isOpen={isOpen}
      ...
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <ul className="list-disc list-inside">
                  ...
                  <li className="text-sm text-gray-500">
                    • Aim at the oncoming ball and shoot by clicking the
                    mouse/mousepad.
                  </li>
                  <li className="text-sm text-gray-500">
                    • You can shift vour position by the arrow keys.{" "}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <Link to="/userDashboard/game/the-shooter">
              {" "}
              <button
                type="button"
...
export default ModalTheShooter;
